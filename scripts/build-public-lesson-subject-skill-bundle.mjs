...
const configs = {
  ...
  english: {
    ...
    migrationPath: join(repoRoot, "supabase/migrations/20260814010000_hai_english_public_lesson_skill_v2.sql"),
    skillDescription: "完整英语公开课设计 Skill：以主题和语篇为依托，按活动观进阶组织理解、实践与迁移，生成双学段可实施可评价的完整教案。",
    ...
    references: [
      ...
      ["references/output-template.md", "英语公开课完整输出模板", "十三部分教案、语篇研读、语言支持、评价反馈和质量硬约束", "always", 20, {}],
      ["references/excellent-example-primary.md", "小学英语优秀教案样例", "基于当前教材摘要重构的 My feelings 对话交际完整示范", "always", 30, { stages: ["小学"] }],
      ["references/excellent-example-junior.md", "初中英语优秀教案样例", "基于获奖课例分析重构的新闻语篇阅读完整示范", "always", 40, { stages: ["初中"] }],
    ...
    outputContract: {
      ...
      required_sections: [
        "课程基本信息", "单元育人蓝图与教材定位", "语篇研读与课程内容分析", "学情与语言学习起点",
        "核心增长与目标—任务—证据", "重难点与突破路径", "主导模式与活动观主线", "教学准备与语言支持",
        "教学流程", "板书设计", "评价量规与差异化支持", "作业与真实迁移", "教学反思",
      ],
      lesson_flow_required: [
        "活动观层级", "环节功能", "语篇范围/情境/对象/目的", "核心问题或任务指令", "个体先行证据",
        "合作必要性", "教师行为与可执行话语", "学生语言行动", "语言/文化/策略支架", "预期产出",
        "典型困难", "评价证据与反馈分支", "内容/语言/结构/得体性落点", "阶段成果与过渡", "时间核算",
      ],
    },
  },
  physics: {
