...
CREATE ROLE "_dbsc";
ALTER ROLE "_dbsc" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:ymeNlRxwdnVFlyIMEd4FgA==$uGkQrGVWo/yEjL1wIzY4ijlJjYtDKRiUxxCab9HZhFM=:XqRaTzrk4IucTOjoHWQZArKAi9XPEcel47x8+BhJT00=';
-- CREATE ROLE "anon";
...
-- ALTER ROLE "authenticator" WITH NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:+zndXVE1tBphLnsbN01C9g==$V6fTDaYXje7IY1bXa/jmIpEeQ1e/hj979AAK0tZO2Qc=:CjLm5jov/QMHEcOPs+9eQix/vAG8K+zex0Wwfqc7l4o=';
-- CREATE ROLE "dashboard_user";
-- ALTER ROLE "dashboard_user" WITH INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
-- CREATE ROLE "pgbouncer";
-- ALTER ROLE "pgbouncer" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:1zpBFa5OKaVA+5fQDRVo2g==$LOijphKjjtHj2f5RvyD1DVrkyOQ03LUI8pCmRbJof0A=:ZOPQe7wBoR58cSUxGMYGg80KJvBuTumya7XpqVBV6OQ=';
CREATE ROLE "pgsync";
ALTER ROLE "pgsync" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN REPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:GKGWIPbuS5F5WZ4D/T8L1Q==$fyjn7pAdGCo4jktpUWyo3hBwy0lLHP0nPU7VSh5zzxM=:ZKCNT12AqZgToY68Il8qjha+y32+KYLaw2dbNSVS3Yk=';
-- CREATE ROLE "postgres";
-- ALTER ROLE "postgres" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:saMCAWmofBZi1oAG/1zhgA==$WooA6B9fbBlbY2LByAbF+WW5v/bxwaYqyCb4m0yAnbA=:mL7sMoimKRkWy1Gc8B97ErCoAIfVqB9u7HwpXk0ptIA=';
-- CREATE ROLE "service_role";
-- ALTER ROLE "service_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN BYPASSRLS;
-- CREATE ROLE "supabase_admin";
-- ALTER ROLE "supabase_admin" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:IztpfAF3ZN8ptxbHKEJDCg==$pM3mXuktRl0tREeMwmkX8fxlivuN8yAORio+++zfGkk=:zj+j1L8KGiUiLs2bF20C5YFXDYcPuk3mbQ48djaTI7o=';
-- CREATE ROLE "supabase_auth_admin";
-- ALTER ROLE "supabase_auth_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:4oqSdmPfdZ65vFaVuLMhkw==$S4Gs1v302IF4ea/Z0Gu0hh20FXpH5kSUUcqbaGIXXY4=:YEWXN7/58PBbHcopTuWRGnFAV7INH2Q1kKKEq53PtIs=';
-- CREATE ROLE "supabase_functions_admin";
-- ALTER ROLE "supabase_functions_admin" WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:Q867sgNNXKNGMfm77y4/wg==$z2MfdgJy5dHQg1O19HU09qOr8UkDHZvKYgoDmO2L8jU=:uJtxJRY/mvJsP26fPEuzQRM7lNfyebrdJ72WidVcl6E=';
...
-- ALTER ROLE "supabase_storage_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:YPkHIMWquxlXcDt1QGN+fg==$tj0zoezsuSNBLzQrYaPD9an23idhikWnVm1eL1OxNy8=:Ga6k06+iQvDUo+h93lSO2ffoJkW7300KtVhbWqBRwTU=';
...
-- GRANT "_dbsc" TO "postgres" WITH ADMIN OPTION, INHERIT FALSE, SET FALSE GRANTED BY "supabase_admin";
...
-- GRANT "pgsync" TO "postgres" WITH ADMIN OPTION, INHERIT FALSE, SET FALSE GRANTED BY "supabase_admin";
...
-- GRANT "supabase_realtime_admin" TO "postgres" WITH ADMIN OPTION, INHERIT FALSE, SET FALSE GRANTED BY "supabase_admin";
...
--
-- Name: auto_fix_course_categories(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."auto_fix_course_categories"() RETURNS TABLE("action_type" "text", "category_name" character varying, "action_description" "text")
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
--
-- Name: batch_update_courses("uuid"[], "jsonb"); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."batch_update_courses"("p_course_ids" "uuid"[], "p_update_data" "jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
BEGIN
  ...
  LOOP
    UPDATE courses SET
      instructor = COALESCE((p_update_data->>'instructor')::text, instructor),
      duration = COALESCE((p_update_data->>'duration')::text, duration),
      rating = COALESCE((p_update_data->>'rating')::numeric, rating),
      category = COALESCE((p_update_data->>'category')::text, category),
      level = COALESCE((p_update_data->>'level')::text, level),
      updated_by = auth.uid()
  ...
  SELECT jsonb_build_object(
    ...
    'success', true,
    'message', format('成功更新 %s 门课程', v_updated_count)
  ) INTO v_result;
...
--
-- Name: create_course_with_details("text", "text", "text", "text", numeric, "text", "text", "text", "text", "text"[], "jsonb", "jsonb"); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."create_course_with_details"("p_title" "text", "p_instructor" "text" DEFAULT NULL::"text", "p_duration" "text" DEFAULT NULL::"text", "p_cover_image" "text" DEFAULT NULL::"text", "p_rating" numeric DEFAULT NULL::numeric, "p_category" "text" DEFAULT NULL::"text", "p_level" "text" DEFAULT NULL::"text", "p_link" "text" DEFAULT NULL::"text", "p_description" "text" DEFAULT NULL::"text", "p_objectives" "text"[] DEFAULT NULL::"text"[], "p_key_points" "jsonb" DEFAULT NULL::"jsonb", "p_reviews" "jsonb" DEFAULT NULL::"jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_course_id uuid;
...
BEGIN
  -- 检查权限
  IF NOT is_editor_or_admin(auth.uid()) THEN
    RAISE EXCEPTION '没有权限创建课程';
  END IF;

  -- 创建课程
  INSERT INTO courses (
    title, instructor, duration, cover_image, rating, 
    category, level, link, created_by, updated_by
  ) VALUES (
    p_title, p_instructor, p_duration, p_cover_image, p_rating,
    p_category, p_level, p_link, auth.uid(), auth.uid()
  ) RETURNING id INTO v_course_id;

  -- 创建课程详情
  INSERT INTO course_details (
    course_id, description, objectives, key_points, reviews
  ) VALUES (
    v_course_id, p_description, p_objectives, p_key_points, p_reviews
  );

  -- 创建初始版本
  INSERT INTO course_versions (course_id, version_number, course_data, details_data, created_by)
  SELECT 
    v_course_id,
    1,
    row_to_json(c.*),
...
--
-- Name: get_category_stats(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."get_category_stats"() RETURNS TABLE("category_name" character varying, "course_count" bigint, "sort_order" integer, "is_active" boolean)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: get_course_statistics(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."get_course_statistics"() RETURNS json
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  result JSON;
BEGIN
  SELECT json_build_object(
    ...
    'total_chapters', (SELECT COUNT(*) FROM course_chapters),
    'total_resources', (SELECT COUNT(*) FROM course_resources),
    'courses_by_category', (
...
--
-- Name: increment_course_view_count("uuid"); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."increment_course_view_count"("course_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  UPDATE courses
...
CREATE FUNCTION "public"."is_editor_or_admin"("uid" "uuid") RETURNS boolean
    LANGUAGE "sql" SECURITY DEFINER
    AS $$
  SELECT EXISTS (
    SELECT 1 FROM profiles p
...
--
-- Name: record_visit("uuid"); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."record_visit"("p_visitor_uuid" "uuid") RETURNS json
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: search_courses("text", "text", "public"."course_level", "public"."course_status"); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."search_courses"("search_term" "text" DEFAULT NULL::"text", "filter_category" "text" DEFAULT NULL::"text", "filter_level" "public"."course_level" DEFAULT NULL::"public"."course_level", "filter_status" "public"."course_status" DEFAULT NULL::"public"."course_status") RETURNS TABLE("id" "uuid", "title" character varying, "description" "text", "instructor" character varying, "category" character varying, "level" "public"."course_level", "duration" integer, "status" "public"."course_status", "created_at" timestamp with time zone)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: update_course_categories_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."update_course_categories_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  NEW.updated_at = NOW();
...
--
-- Name: update_course_with_version("uuid", "jsonb", "jsonb"); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."update_course_with_version"("p_course_id" "uuid", "p_course_data" "jsonb", "p_details_data" "jsonb" DEFAULT NULL::"jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
BEGIN
  -- 检查权限
  IF NOT is_editor_or_admin(auth.uid()) THEN
    RAISE EXCEPTION '没有权限更新课程';
  END IF;

  -- 更新课程基础信息
  UPDATE courses SET
    title = COALESCE((p_course_data->>'title')::text, title),
    instructor = COALESCE((p_course_data->>'instructor')::text, instructor),
    duration = COALESCE((p_course_data->>'duration')::text, duration),
    cover_image = COALESCE((p_course_data->>'cover_image')::text, cover_image),
    rating = COALESCE((p_course_data->>'rating')::numeric, rating),
    category = COALESCE((p_course_data->>'category')::text, category),
    level = COALESCE((p_course_data->>'level')::text, level),
    link = COALESCE((p_course_data->>'link')::text, link),
    updated_by = auth.uid()
  WHERE id = p_course_id;

  -- 更新课程详情（如果提供）
  IF p_details_data IS NOT NULL THEN
    UPDATE course_details SET
      description = COALESCE((p_details_data->>'description')::text, description),
      objectives = COALESCE((p_details_data->>'objectives')::text[], objectives),
      key_points = COALESCE(p_details_data->'key_points', key_points),
      reviews = COALESCE(p_details_data->'reviews', reviews)
...
--
-- Name: validate_course_categories(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION "public"."validate_course_categories"() RETURNS TABLE("validation_type" "text", "category_name" character varying, "issue_description" "text")
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: TABLE "course_categories"; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN "course_categories"."id"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."course_categories"."id" IS '类别ID（主键）';


--
-- Name: COLUMN "course_categories"."name"; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN "course_categories"."description"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."course_categories"."description" IS '类别描述';


--
-- Name: COLUMN "course_categories"."sort_order"; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN "course_categories"."created_at"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."course_categories"."created_at" IS '创建时间';


--
-- Name: COLUMN "course_categories"."updated_at"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."course_categories"."updated_at" IS '最后更新时间';


--
-- Name: COLUMN "course_categories"."is_active"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."course_categories"."is_active" IS '是否启用（前端只显示启用的分类）';


--
-- Name: COLUMN "course_categories"."applicable_audience"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."course_categories"."applicable_audience" IS '适用人群（数组）';


--
-- Name: COLUMN "course_categories"."applicable_scenarios"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."course_categories"."applicable_scenarios" IS '适用场景（数组）';


--
-- Name: COLUMN "course_categories"."content_types"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."course_categories"."content_types" IS '内容类型（数组）';
...
--
-- Name: COLUMN "courses"."id"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."courses"."id" IS '课程ID（主键）';
...
COMMENT ON COLUMN "public"."courses"."description" IS '课程描述';


--
-- Name: COLUMN "courses"."instructor"; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN "courses"."category_id"; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN "courses"."category"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."courses"."category" IS '课程类别（冗余字段，便于查询）';


--
-- Name: COLUMN "courses"."level"; Type: COMMENT; Schema: public; Owner: -
--
...
COMMENT ON COLUMN "public"."courses"."semester" IS '开设学期/时间';


--
-- Name: COLUMN "courses"."duration"; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN "courses"."credits"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."courses"."credits" IS '学分';


--
-- Name: COLUMN "courses"."status"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."courses"."status" IS '课程状态（draft=草稿，published=已发布，archived=已归档）';


--
-- Name: COLUMN "courses"."image_url"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."courses"."image_url" IS '课程配图URL';


--
-- Name: COLUMN "courses"."video_url"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."courses"."video_url" IS '课程视频URL';


--
-- Name: COLUMN "courses"."meeting_url"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."courses"."meeting_url" IS '腾讯会议链接';


--
-- Name: COLUMN "courses"."sort_order"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."courses"."sort_order" IS '排序顺序';


--
-- Name: COLUMN "courses"."view_count"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."courses"."view_count" IS '浏览次数';


--
-- Name: COLUMN "courses"."created_at"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."courses"."created_at" IS '创建时间';


--
-- Name: COLUMN "courses"."updated_at"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."courses"."updated_at" IS '最后更新时间';


--
-- Name: COLUMN "courses"."membership_type"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."courses"."membership_type" IS '会员类型：free-免费课程，plus-Plus会员课程，pro-Pro会员课程';


--
-- Name: COLUMN "courses"."is_trial"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN "public"."courses"."is_trial" IS '是否为试看课程（免费试看）';


--
-- Name: v_category_course_mapping; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: VIEW "v_category_course_mapping"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON VIEW "public"."v_category_course_mapping" IS '分类与课程关联视图，用于快速查询分类下的所有课程';
...
--
-- Name: visitor_stats visitor_stats_visitor_uuid_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."visitor_stats"
    ADD CONSTRAINT "visitor_stats_visitor_uuid_key" UNIQUE ("visitor_uuid");
...
--
-- Name: idx_course_categories_applicable_audience; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_course_categories_applicable_scenarios; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_course_categories_content_types; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_course_categories_is_active; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_course_categories_scenarios; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_course_categories_sort_order; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_courses_is_trial; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_courses_membership_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_visitor_stats_uuid; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: course_categories trigger_update_course_categories_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "trigger_update_course_categories_updated_at" BEFORE UPDATE ON "public"."course_categories" FOR EACH ROW EXECUTE FUNCTION "public"."update_course_categories_updated_at"();


--
-- Name: course_categories update_course_categories_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
