...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      {/* Hero Section - 欢迎区域 */}
      <section className="relative py-12 md:py-24 xl:py-40 px-4 overflow-hidden pt-24 md:pt-32 xl:pt-48 bg-[transparent] bg-none">
        {/* 装饰性几何图形 - 在手机端隐藏 */}
        ...
        <div className="relative max-w-6xl mx-auto text-center space-y-6 md:space-y-10">
          <div className="space-y-4 md:space-y-6 animate-fade-in-down">
            ...
            <h1 className="text-3xl md:text-5xl xl:text-7xl font-black text-foreground tracking-tight leading-tight">
              Hi，欢迎来到
              <br />
              <span className="text-foreground">教学设计师俱乐部</span>
            </h1>
            <p className="text-base md:text-xl xl:text-3xl text-foreground/80 max-w-3xl mx-auto leading-relaxed font-medium">{"致力于实现备课流程化、教学工程化，让天下没有难备的课✌🏻"}</p>
          </div>
          
          <div className="flex flex-col items-center gap-4 md:gap-6 animate-fade-in-up">
            <Button 
              size="lg" 
              className="btn-pill text-base md:text-lg xl:text-xl px-8 md:px-12 xl:px-16 py-4 md:py-7 xl:py-8 bg-primary text-primary-foreground hover:bg-primary/90 shadow-[var(--shadow-elegant)] font-bold border-2 border-primary"
      ...
      {/* 俱乐部介绍 */}
      <section id="introduction" className="py-8 md:py-16 xl:py-24 px-4 bg-yellow-soft">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-2xl md:text-4xl xl:text-5xl font-black text-foreground mb-4">俱乐部介绍</h2>
            <p className="text-base md:text-lg xl:text-xl text-foreground/70">Hi，热爱教学的老师！</p>
          </div>
          
          <Card className="card-bordered shadow-[var(--shadow-card)] hover-lift">
            <CardHeader>
              <CardTitle className="text-xl md:text-2xl xl:text-3xl font-bold">欢迎加入我们</CardTitle>
            ...
            <CardContent className="space-y-4 md:space-y-6">
              ...
              <div className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-xl p-4 md:p-6 border border-primary/20">
                <div className="flex items-center gap-2 mb-3 md:mb-4">
                  ...
                  <h3 className="font-bold text-lg md:text-xl text-foreground">俱乐部价值观</h3>
                </div>
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-3 md:gap-4">
                  <div className="flex items-start gap-2 md:gap-3 bg-background/80 rounded-lg p-3 md:p-4">
                    <span className="text-lg md:text-xl flex-shrink-0">✨</span>
                    <p className="text-sm md:text-base text-foreground">
                      相信<strong className="text-primary">专业方法</strong>先于直觉和经验
                    </p>
                  </div>
                  <div className="flex items-start gap-2 md:gap-3 bg-background/80 rounded-lg p-3 md:p-4">
                    <span className="text-lg md:text-xl flex-shrink-0">🎯</span>
                    <p className="text-sm md:text-base text-foreground">
                      相信<strong className="text-primary">学习是可以被优化的</strong>
                    </p>
                  </div>
                  <div className="flex items-start gap-2 md:gap-3 bg-background/80 rounded-lg p-3 md:p-4">
                    <span className="text-lg md:text-xl flex-shrink-0">🔬</span>
                    <p className="text-sm md:text-base text-foreground">
                      相信有效的教学是<strong className="text-primary">科学循证的</strong>
                    </p>
                  </div>
                  <div className="flex items-start gap-2 md:gap-3 bg-background/80 rounded-lg p-3 md:p-4">
                    <span className="text-lg md:text-xl flex-shrink-0">⚡</span>
                    <p className="text-sm md:text-base text-foreground">
                      相信优质的教学是<strong className="text-primary">有效果、有参与度、有效率的</strong>
                    </p>
                  </div>
                  <div className="flex items-start gap-2 md:gap-3 bg-background/80 rounded-lg p-3 md:p-4">
                    <span className="text-lg md:text-xl flex-shrink-0">🤝</span>
                    <p className="text-sm md:text-base text-foreground">
                      <strong className="text-primary">尊重学习者的主体性</strong>
                    </p>
                  </div>
                  <div className="flex items-start gap-2 md:gap-3 bg-background/80 rounded-lg p-3 md:p-4">
                    <span className="text-lg md:text-xl flex-shrink-0">🧩</span>
                    <p className="text-sm md:text-base text-foreground">
                      相信<strong className="text-primary">复杂的事物可以被拆解</strong>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                <h3 className="font-semibold text-lg mb-3 text-foreground">在俱乐部中，包括Plus课程和Pro课程两大会员产品：</h3>
                <ul className="space-y-3 text-muted-foreground">
                  <li key="plus-course" className="flex items-start gap-3">
                    <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-primary/10 text-primary text-sm font-medium flex-shrink-0 mt-0.5">1</span>
                    <span className="text-foreground">{"Plus会员课程：让你获得教学设计的专业框架和审美，实现教学科学化。课程包括重构讲授法、教学法通识、AI通识、建构主义、真实任务设计、教学目标、学习科学等60余节课程，持续更新中；"}</span>
                  </li>
                  <li key="pro-course" className="flex items-start gap-3">
                    <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-primary/10 text-primary text-sm font-medium flex-shrink-0 mt-0.5">2</span>
                    <span className="text-foreground">{"Pro会员课程：帮助你用AI赋能教学，实现教学工程化。课程包括ClaudeCode教程、AI科普、AI工具测评和演示，持续更新中。"}</span>
                  </li>
                </ul>
              </div>
            </CardContent>
      ...
      <section id="founder" className="py-12 xl:py-16 px-4 bg-[#ecece5ff] bg-none">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            <Sparkles className="w-6 h-6 xl:w-8 xl:h-8 text-primary" />
            <h2 className="text-2xl xl:text-3xl font-bold text-foreground">俱乐部创始人</h2>
          </div>
      ...
      {/* 课程试看 */}
      {/* 免费课程 */}
      <section id="free-courses" className="py-8 md:py-16 xl:py-24 px-4 relative overflow-hidden bg-[#00000000] bg-none">
        {/* 装饰元素 */}
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="text-center mb-8 md:mb-16 animate-fade-in">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h2 className="text-2xl md:text-4xl xl:text-5xl font-black text-foreground">免费课程</h2>
            </div>
            <p className="text-base md:text-lg xl:text-xl text-foreground/70">精选免费课程，零门槛体验专业教学设计</p>
          </div>
      ...
      {/* 会员课程 */}
      <section id="member-courses" className="py-8 md:py-16 xl:py-24 px-4 relative overflow-hidden bg-gradient-to-b from-background to-muted/20">
        {/* 装饰元素 */}
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="text-center mb-12 md:mb-20 animate-fade-in">
            <h2 className="text-2xl md:text-4xl xl:text-5xl font-black text-foreground mb-4">会员课程体系</h2>
            <p className="text-base md:text-lg xl:text-xl text-foreground/70">从教学科学化到教学工程化的完整学习路径</p>
          </div>
            ...
            <div className="space-y-16 md:space-y-24">
              ...
              <div className="animate-fade-in-up">
                <div className="flex items-center gap-4 mb-8 md:mb-12">
                  <div className="flex items-center gap-3 px-6 py-3 rounded-2xl bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-lg">
                    <Star className="w-6 h-6 md:w-7 md:h-7" />
                    <div>
                      <h3 className="text-xl md:text-2xl xl:text-3xl font-black">教学通识课（Plus）</h3>
                      <p className="text-sm md:text-base opacity-90">目标：教学科学化</p>
                    </div>
                  </div>
                </div>

                <div className="mb-6 p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border-2 border-blue-200">
                  <h4 className="text-lg font-bold text-foreground mb-3">课程定位</h4>
              ...
              <div className="animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                <div className="flex items-center gap-4 mb-8 md:mb-12">
                  <div className="flex items-center gap-3 px-6 py-3 rounded-2xl bg-gradient-to-r from-amber-500 to-orange-600 text-white shadow-lg">
                    <Crown className="w-6 h-6 md:w-7 md:h-7" />
                    <div>
                      <h3 className="text-xl md:text-2xl xl:text-3xl font-black">教师AI课（Pro）</h3>
                      <p className="text-sm md:text-base opacity-90">目标：教学工程化</p>
                    </div>
                  </div>
                </div>

                <div className="mb-6 p-6 bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl border-2 border-amber-200">
                  <h4 className="text-lg font-bold text-foreground mb-3">课程定位</h4>
                  <p className="text-foreground/80 leading-relaxed">
      ...
      <section id="stats" className="py-8 md:py-16 xl:py-24 px-4 bg-blue-soft relative overflow-hidden">
        {/* 装饰元素 - 在手机端隐藏 */}
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="text-center mb-8 md:mb-16 animate-fade-in">
            <h2 className="text-2xl md:text-4xl xl:text-5xl font-black text-foreground mb-4">俱乐部数据</h2>
            <p className="text-base md:text-lg xl:text-xl text-foreground/70">持续成长的学习社区</p>
          </div>

          <div className="grid grid-cols-2 xl:grid-cols-5 gap-4 md:gap-6 xl:gap-8">
            {/* 会员人数 */}
            <Card className="card-bordered shadow-[var(--shadow-card)] bg-card hover-lift animate-scale-in">
              <CardContent className="p-4 md:p-8 text-center space-y-2 md:space-y-4">
                <Users className="w-8 h-8 md:w-12 md:h-12 xl:w-14 xl:h-14 text-primary mx-auto transition-transform duration-300 hover:scale-110" />
                <div>
                  <p className="text-3xl md:text-5xl xl:text-6xl font-black text-foreground mb-1 md:mb-2">
            ...
            <Card className="card-bordered shadow-[var(--shadow-card)] bg-card hover-lift animate-scale-in" style={{ animationDelay: '0.1s' }}>
              <CardContent className="p-4 md:p-8 text-center space-y-2 md:space-y-4">
                <GraduationCap className="w-8 h-8 md:w-12 md:h-12 xl:w-14 xl:h-14 text-primary mx-auto transition-transform duration-300 hover:scale-110" />
                <div>
                  <p className="text-3xl md:text-5xl xl:text-6xl font-black text-foreground mb-1 md:mb-2">
            ...
            <Card className="card-bordered shadow-[var(--shadow-card)] bg-card hover-lift animate-scale-in" style={{ animationDelay: '0.2s' }}>
              <CardContent className="p-4 md:p-8 text-center space-y-2 md:space-y-4">
                <BookOpen className="w-8 h-8 md:w-12 md:h-12 xl:w-14 xl:h-14 text-primary mx-auto transition-transform duration-300 hover:scale-110" />
                <div>
                  <p className="text-3xl md:text-5xl xl:text-6xl font-black text-foreground mb-1 md:mb-2">
            ...
            <Card className="card-bordered shadow-[var(--shadow-card)] bg-card hover-lift animate-scale-in" style={{ animationDelay: '0.3s' }}>
              <CardContent className="p-4 md:p-8 text-center space-y-2 md:space-y-4">
                <Clock className="w-8 h-8 md:w-12 md:h-12 xl:w-14 xl:h-14 text-primary mx-auto transition-transform duration-300 hover:scale-110" />
                <div>
                  <p className="text-3xl md:text-5xl xl:text-6xl font-black text-foreground mb-1 md:mb-2">
            ...
            <Card className="card-bordered shadow-[var(--shadow-card)] bg-card hover-lift animate-scale-in" style={{ animationDelay: '0.4s' }}>
              <CardContent className="p-4 md:p-8 text-center space-y-2 md:space-y-4">
                <Calendar className="w-8 h-8 md:w-12 md:h-12 xl:w-14 xl:h-14 text-primary mx-auto transition-transform duration-300 hover:scale-110" />
                <div>
                  <p className="text-3xl md:text-5xl xl:text-6xl font-black text-foreground mb-1 md:mb-2">
          ...
          <div className="mt-12 text-center">
            <p className="text-foreground/70 text-lg font-medium">💪 持续成长的学习社群，与几百位教育者一起探索AI时代的教学设计</p>
          </div>
        </div>
      </section>
      {/* 部分会员简介 */}
      <section id="members" className="py-12 xl:py-16 px-4 bg-background">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-8 animate-fade-in">
            <UserCheck className="w-6 h-6 xl:w-8 xl:h-8 text-primary" />
            <h2 className="text-2xl xl:text-3xl font-bold text-foreground">部分会员简介</h2>
          </div>
            ...
            <CardContent className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                {[
                  ...
                  <div
                    key={index}
                    className="flex items-start gap-3 p-4 rounded-lg bg-muted/30 hover:bg-muted/50 hover-lift transition-all duration-200 border border-border group"
                  >
                    <div className="text-3xl flex-shrink-0 transition-transform duration-300 group-hover:scale-125">{member.icon}</div>
                    <div className="flex-1 min-w-0">
                      <p className="font-semibold text-foreground mb-1 text-sm">{member.name}</p>
          ...
          <div className="mt-12 md:mt-16 text-center animate-fade-in-up">
            ...
            <p className="text-xs md:text-sm text-foreground/70 mt-4 md:mt-6 font-medium">
              点击按钮填写报名表单，开启你的学习之旅
            </p>
          </div>
        </div>
      ...
      {/* 俱乐部课程介绍 */}
      <section id="testimonials" className="py-12 xl:py-16 px-4 bg-secondary/30">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            <Quote className="w-6 h-6 xl:w-8 xl:h-8 text-primary" />
            <h2 className="text-2xl xl:text-3xl font-bold text-foreground">会员老师们这么说</h2>
          </div>
      ...
      {/* CTA 报名邀请 */}
      <section id="faq" className="py-12 xl:py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            <span className="text-3xl">❓</span>
            <h2 className="text-2xl xl:text-3xl font-bold text-foreground">FAQ 常见问题解答</h2>
          </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="border-border shadow-[var(--shadow-card)] hover-lift">
              <CardHeader>
                <CardTitle className="text-lg xl:text-xl text-foreground">
