...
| 接口 | 方法 | Endpoint |
|------|------|----------|
| 提交任务 | POST | `https://app-7iwdhpt0pypt-api-ra5EZDjVKkXa-gateway.appmiaoda.com/image-generation/submit` |
| 查询状态 | POST/GET | `https://app-7iwdhpt0pypt-api-VaOwP2jDmAga-gateway.appmiaoda.com/image-generation/task` |
