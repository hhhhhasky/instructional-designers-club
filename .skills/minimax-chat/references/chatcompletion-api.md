...
| Endpoint | `POST https://app-7iwdhpt0pypt-api-Aa2PqMJnJGwL-gateway.appmiaoda.com/v1/text/chatcompletion_v2` |
| Third-party Domain | `app-7iwdhpt0pypt-api-Aa2PqMJnJGwL-gateway.appmiaoda.com` |
...
async function callMiniMaxChat(request: ChatCompletionRequest): Promise<ChatCompletionResponse> {
  const response = await fetch(
    "https://app-7iwdhpt0pypt-api-Aa2PqMJnJGwL-gateway.appmiaoda.com/v1/text/chatcompletion_v2",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
