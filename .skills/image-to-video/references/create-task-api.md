...
| Endpoint | `POST https://app-7iwdhpt0pypt-api-m9xKX785MdZa-gateway.appmiaoda.com/beta/video/generations/kling/image2video` |
| Auth 模式 | `platform_managed`（密钥由平台注入） |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| third_part_domain | `app-7iwdhpt0pypt-api-m9xKX785MdZa-gateway.appmiaoda.com` |
