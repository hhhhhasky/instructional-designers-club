...
- **Endpoint**：`POST https://app-7iwdhpt0pypt-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-7iwdhpt0pypt-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
