...
| 属性 | 值 |
|------|---|
| Endpoint | `GET https://app-7iwdhpt0pypt-api-DYJwn2VZXvEa-gateway.appmiaoda.com/api_region_search/v1/` |
...
async function queryAdminRegion(
  ...
  const response = await fetch(
    `https://app-7iwdhpt0pypt-api-DYJwn2VZXvEa-gateway.appmiaoda.com/api_region_search/v1/?${params.toString()}`,
    {
      method: "GET",
      headers: {
