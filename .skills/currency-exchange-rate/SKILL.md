...
- **Endpoint**: `POST https://app-7iwdhpt0pypt-api-ELbWz8OmBW5Y-gateway.appmiaoda.com/exchange-rate-v2/single`
...
async function getExchangeRates(fromCode: string): Promise<ExchangeRateData> {
  const response = await fetch(
    "https://app-7iwdhpt0pypt-api-ELbWz8OmBW5Y-gateway.appmiaoda.com/exchange-rate-v2/single",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
